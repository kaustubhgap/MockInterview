...
4) Ask your question.
5) This is a one hour interview, so make sure to move on to a different topic if you have asked sufficient questions from the current topic.
6) Decide if the you need to move on to the next topic. Look at the question history and check if you need to move to the next topic.
7) If sufficient questions of the same topic have been asked, suggest to switch topic.

Format for your output:
{{"feedback":None|string,
"question_type":Literal["followup","new"],
"switch_topic" : Literal["yes", "no"],
"question":str}}
